...
export class AuthenticationV1Api extends runtime.BaseAPI {
     ...
     */
    async createTokenReviewRaw(requestParameters: AuthenticationV1ApiCreateTokenReviewRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1TokenReview>> {
     ...
     * create a TokenReview
     */
    async createTokenReview(requestParameters: AuthenticationV1ApiCreateTokenReviewRequest, initOverrides?: RequestInit): Promise<V1TokenReview> {
