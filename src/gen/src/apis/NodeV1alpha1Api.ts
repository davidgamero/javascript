...
import {
    ...
    V1alpha1RuntimeClassFromJSON,
    V1alpha1RuntimeClassToJSON,
    V1alpha1RuntimeClassList,
    V1alpha1RuntimeClassListFromJSON,
    V1alpha1RuntimeClassListToJSON,
} from '../models';
...
export class NodeV1alpha1Api extends runtime.BaseAPI {
     ...
     */
    async createRuntimeClassRaw(requestParameters: NodeV1alpha1ApiCreateRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        ...
        const response = await this.request({
            ...
            body: V1alpha1RuntimeClassToJSON(requestParameters.body),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1RuntimeClassFromJSON(jsonValue));
    }

    /**
     * create a RuntimeClass
     */
    async createRuntimeClass(requestParameters: NodeV1alpha1ApiCreateRuntimeClassRequest, initOverrides?: RequestInit): Promise<V1alpha1RuntimeClass> {
     ...
     */
    async deleteCollectionRuntimeClassRaw(requestParameters: NodeV1alpha1ApiDeleteCollectionRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1Status>> {
        const queryParameters: any = {};
     ...
     * delete collection of RuntimeClass
     */
    async deleteCollectionRuntimeClass(requestParameters: NodeV1alpha1ApiDeleteCollectionRuntimeClassRequest = {}, initOverrides?: RequestInit): Promise<V1Status> {
     ...
     */
    async deleteRuntimeClassRaw(requestParameters: NodeV1alpha1ApiDeleteRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1Status>> {
     ...
     * delete a RuntimeClass
     */
    async deleteRuntimeClass(requestParameters: NodeV1alpha1ApiDeleteRuntimeClassRequest, initOverrides?: RequestInit): Promise<V1Status> {
     ...
     */
    async listRuntimeClassRaw(requestParameters: NodeV1alpha1ApiListRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1RuntimeClassList>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1RuntimeClassListFromJSON(jsonValue));
    }

    /**
     * list or watch objects of kind RuntimeClass
     */
    async listRuntimeClass(requestParameters: NodeV1alpha1ApiListRuntimeClassRequest = {}, initOverrides?: RequestInit): Promise<V1alpha1RuntimeClassList> {
     ...
     */
    async patchRuntimeClassRaw(requestParameters: NodeV1alpha1ApiPatchRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified RuntimeClass
     */
    async patchRuntimeClass(requestParameters: NodeV1alpha1ApiPatchRuntimeClassRequest, initOverrides?: RequestInit): Promise<V1alpha1RuntimeClass> {
     ...
     */
    async readRuntimeClassRaw(requestParameters: NodeV1alpha1ApiReadRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified RuntimeClass
     */
    async readRuntimeClass(requestParameters: NodeV1alpha1ApiReadRuntimeClassRequest, initOverrides?: RequestInit): Promise<V1alpha1RuntimeClass> {
     ...
     */
    async replaceRuntimeClassRaw(requestParameters: NodeV1alpha1ApiReplaceRuntimeClassRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1RuntimeClass>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified RuntimeClass
     */
    async replaceRuntimeClass(requestParameters: NodeV1alpha1ApiReplaceRuntimeClassRequest, initOverrides?: RequestInit): Promise<V1alpha1RuntimeClass> {
