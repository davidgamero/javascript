...
export class ApiregistrationV1Api extends runtime.BaseAPI {
     ...
     */
    async createAPIServiceRaw(requestParameters: ApiregistrationV1ApiCreateAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
     ...
     * create an APIService
     */
    async createAPIService(requestParameters: ApiregistrationV1ApiCreateAPIServiceRequest, initOverrides?: RequestInit): Promise<V1APIService> {
     ...
     */
    async deleteAPIServiceRaw(requestParameters: ApiregistrationV1ApiDeleteAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1Status>> {
     ...
     * delete an APIService
     */
    async deleteAPIService(requestParameters: ApiregistrationV1ApiDeleteAPIServiceRequest, initOverrides?: RequestInit): Promise<V1Status> {
     ...
     */
    async deleteCollectionAPIServiceRaw(requestParameters: ApiregistrationV1ApiDeleteCollectionAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1Status>> {
        const queryParameters: any = {};
     ...
     * delete collection of APIService
     */
    async deleteCollectionAPIService(requestParameters: ApiregistrationV1ApiDeleteCollectionAPIServiceRequest = {}, initOverrides?: RequestInit): Promise<V1Status> {
     ...
     */
    async listAPIServiceRaw(requestParameters: ApiregistrationV1ApiListAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIServiceList>> {
        const queryParameters: any = {};
     ...
     * list or watch objects of kind APIService
     */
    async listAPIService(requestParameters: ApiregistrationV1ApiListAPIServiceRequest = {}, initOverrides?: RequestInit): Promise<V1APIServiceList> {
     ...
     */
    async patchAPIServiceRaw(requestParameters: ApiregistrationV1ApiPatchAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update the specified APIService
     */
    async patchAPIService(requestParameters: ApiregistrationV1ApiPatchAPIServiceRequest, initOverrides?: RequestInit): Promise<V1APIService> {
     ...
     */
    async patchAPIServiceStatusRaw(requestParameters: ApiregistrationV1ApiPatchAPIServiceStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update status of the specified APIService
     */
    async patchAPIServiceStatus(requestParameters: ApiregistrationV1ApiPatchAPIServiceStatusRequest, initOverrides?: RequestInit): Promise<V1APIService> {
     ...
     */
    async readAPIServiceRaw(requestParameters: ApiregistrationV1ApiReadAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read the specified APIService
     */
    async readAPIService(requestParameters: ApiregistrationV1ApiReadAPIServiceRequest, initOverrides?: RequestInit): Promise<V1APIService> {
     ...
     */
    async readAPIServiceStatusRaw(requestParameters: ApiregistrationV1ApiReadAPIServiceStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read status of the specified APIService
     */
    async readAPIServiceStatus(requestParameters: ApiregistrationV1ApiReadAPIServiceStatusRequest, initOverrides?: RequestInit): Promise<V1APIService> {
     ...
     */
    async replaceAPIServiceRaw(requestParameters: ApiregistrationV1ApiReplaceAPIServiceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace the specified APIService
     */
    async replaceAPIService(requestParameters: ApiregistrationV1ApiReplaceAPIServiceRequest, initOverrides?: RequestInit): Promise<V1APIService> {
     ...
     */
    async replaceAPIServiceStatusRaw(requestParameters: ApiregistrationV1ApiReplaceAPIServiceStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIService>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace status of the specified APIService
     */
    async replaceAPIServiceStatus(requestParameters: ApiregistrationV1ApiReplaceAPIServiceStatusRequest, initOverrides?: RequestInit): Promise<V1APIService> {
