...
export class LogsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async logFileHandlerRaw(requestParameters: LogsApiLogFileHandlerRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async logFileHandler(requestParameters: LogsApiLogFileHandlerRequest, initOverrides?: RequestInit): Promise<void> {
