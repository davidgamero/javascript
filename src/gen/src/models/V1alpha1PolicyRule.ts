 ...
 */
export interface V1alpha1PolicyRule {
    /**
...
export function V1alpha1PolicyRuleFromJSON(json: any): V1alpha1PolicyRule {
    return V1alpha1PolicyRuleFromJSONTyped(json, false);
}

export function V1alpha1PolicyRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha1PolicyRule {
...
export function V1alpha1PolicyRuleToJSON(value?: V1alpha1PolicyRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
