...
export function V1APIServiceSpecFromJSON(json: any): V1APIServiceSpec {
    return V1APIServiceSpecFromJSONTyped(json, false);
}

export function V1APIServiceSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1APIServiceSpec {
    ...
    return {
        ...
        'service': !exists(json, 'service') ? undefined : ApiregistrationV1ServiceReferenceFromJSON(json['service']),
        'version': !exists(json, 'version') ? undefined : json['version'],
        'versionPriority': json['versionPriority'],
    };
}

export function V1APIServiceSpecToJSON(value?: V1APIServiceSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'service': ApiregistrationV1ServiceReferenceToJSON(value.service),
