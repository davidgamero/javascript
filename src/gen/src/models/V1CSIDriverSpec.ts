...
export function V1CSIDriverSpecFromJSON(json: any): V1CSIDriverSpec {
    return V1CSIDriverSpecFromJSONTyped(json, false);
}

export function V1CSIDriverSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1CSIDriverSpec {
    ...
    return {
        ...
        'tokenRequests': !exists(json, 'tokenRequests') ? undefined : ((json['tokenRequests'] as Array<any>).map(StorageV1TokenRequestFromJSON)),
        'volumeLifecycleModes': !exists(json, 'volumeLifecycleModes') ? undefined : json['volumeLifecycleModes'],
    };
}

export function V1CSIDriverSpecToJSON(value?: V1CSIDriverSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'tokenRequests': value.tokenRequests === undefined ? undefined : ((value.tokenRequests as Array<any>).map(StorageV1TokenRequestToJSON)),
