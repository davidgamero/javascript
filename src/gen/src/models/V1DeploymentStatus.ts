...
export function V1DeploymentStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1DeploymentStatus {
    ...
    return {
        ...
        'conditions': !exists(json, 'conditions') ? undefined : ((json['conditions'] as Array<any>).map(V1DeploymentConditionFromJSON)),
...
export function V1DeploymentStatusToJSON(value?: V1DeploymentStatus | null): any {
    ...
    return {
        ...
        'conditions': value.conditions === undefined ? undefined : ((value.conditions as Array<any>).map(V1DeploymentConditionToJSON)),
