...
export function V2beta1HorizontalPodAutoscalerStatusFromJSON(json: any): V2beta1HorizontalPodAutoscalerStatus {
    return V2beta1HorizontalPodAutoscalerStatusFromJSONTyped(json, false);
}

export function V2beta1HorizontalPodAutoscalerStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V2beta1HorizontalPodAutoscalerStatus {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'conditions': ((json['conditions'] as Array<any>).map(V2beta1HorizontalPodAutoscalerConditionFromJSON)),
        'currentMetrics': !exists(json, 'currentMetrics') ? undefined : ((json['currentMetrics'] as Array<any>).map(V2beta1MetricStatusFromJSON)),
...
export function V2beta1HorizontalPodAutoscalerStatusToJSON(value?: V2beta1HorizontalPodAutoscalerStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'conditions': ((value.conditions as Array<any>).map(V2beta1HorizontalPodAutoscalerConditionToJSON)),
        'currentMetrics': value.currentMetrics === undefined ? undefined : ((value.currentMetrics as Array<any>).map(V2beta1MetricStatusToJSON)),
