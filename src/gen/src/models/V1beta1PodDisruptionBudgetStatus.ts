...
export function V1beta1PodDisruptionBudgetStatusFromJSON(json: any): V1beta1PodDisruptionBudgetStatus {
    return V1beta1PodDisruptionBudgetStatusFromJSONTyped(json, false);
}

export function V1beta1PodDisruptionBudgetStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1PodDisruptionBudgetStatus {
...
export function V1beta1PodDisruptionBudgetStatusToJSON(value?: V1beta1PodDisruptionBudgetStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
