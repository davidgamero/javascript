...
export function V1alpha1StorageVersionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha1StorageVersionStatus {
    ...
    return {
        ...
        'conditions': !exists(json, 'conditions') ? undefined : ((json['conditions'] as Array<any>).map(V1alpha1StorageVersionConditionFromJSON)),
        'storageVersions': !exists(json, 'storageVersions') ? undefined : ((json['storageVersions'] as Array<any>).map(V1alpha1ServerStorageVersionFromJSON)),
    };
}
...
export function V1alpha1StorageVersionStatusToJSON(value?: V1alpha1StorageVersionStatus | null): any {
    ...
    return {
        ...
        'conditions': value.conditions === undefined ? undefined : ((value.conditions as Array<any>).map(V1alpha1StorageVersionConditionToJSON)),
        'storageVersions': value.storageVersions === undefined ? undefined : ((value.storageVersions as Array<any>).map(V1alpha1ServerStorageVersionToJSON)),
    };
}
