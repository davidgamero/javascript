...
export function V1StorageClassFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1StorageClass {
    ...
    return {
        ...
        'allowedTopologies': !exists(json, 'allowedTopologies') ? undefined : ((json['allowedTopologies'] as Array<any>).map(V1TopologySelectorTermFromJSON)),
...
export function V1StorageClassToJSON(value?: V1StorageClass | null): any {
    ...
    return {
        ...
        'allowedTopologies': value.allowedTopologies === undefined ? undefined : ((value.allowedTopologies as Array<any>).map(V1TopologySelectorTermToJSON)),
